...
@Component({
  selector: 'app-crmcasecommunication',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule,TippyDirective],
  templateUrl: './crmcasecommunication.component.html',
  styleUrls: ['./crmcasecommunication.component.scss']
})
export class CrmcasecommunicationComponent extends AbstractComponent {
  defaultcase:string = "";
  res: any = [];
  res2:any=[];
