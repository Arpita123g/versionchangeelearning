...
@Component({
  selector: 'app-orderingbasicssynopsis',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './orderingbasicssynopsis.component.html',
  styleUrls: ['./orderingbasicssynopsis.component.scss'],
...
export class OrderingbasicssynopsisComponent extends AbstractComponent {
  ...
  databasecellname:string[]=[
    "ap10","ap11","ap15","ap16","j63","w63","j64","w64","j65","w65", //9
    "m63","z63","m64","z64","m65","z65","m66","z66",//17
    "j67","w68","m67","z67","ap25"
  ];
