...
@Component({
  selector: 'app-logisticscaseoutbound',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './logisticscaseoutbound.component.html',
  styleUrls: ['./logisticscaseoutbound.component.scss']
})
export class LogisticscaseoutboundComponent extends AbstractComponent {
  defaultcase:string = "";
  res: any = [];
