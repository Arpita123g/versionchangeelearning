...
@Component({
  selector: 'app-ecommerccaseexperience',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './ecommerccaseexperience.component.html',
  styleUrls: ['./ecommerccaseexperience.component.scss']
})
export class EcommerccaseexperienceComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
