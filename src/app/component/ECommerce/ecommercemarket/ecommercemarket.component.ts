...
@Component({
  selector: 'app-ecommercemarket',
  standalone: true,
  imports: [CommonModule, MatDialogModule, RouterModule, MatButtonModule],
  templateUrl: './ecommercemarket.component.html',
  styleUrls: ['./ecommercemarket.component.scss']
})
export class EcommercemarketComponent extends AbstractComponent {
        ...
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
              ...
              let outlookdata = data.resultList[0].ecommerceGameCM.ecommercegameperioddata.b5;
