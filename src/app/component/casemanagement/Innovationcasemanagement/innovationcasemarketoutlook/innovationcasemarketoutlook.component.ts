...
@Component({
  selector: 'app-innovationcasemarketoutlook',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule, NgxSimpleTextEditorModule],
  templateUrl: './innovationcasemarketoutlook.component.html',
  styleUrls: ['./innovationcasemarketoutlook.component.scss']
})
export class InnovationcasemarketoutlookComponent extends AbstractComponent {
  ...
  contentvaluechange() {
    ...
    this._api.updatecasemanagementdata(String(round), "normal", "no", 'innovationgamecm', body, {}, apiname, 'innovationgamecmactivestatus').subscribe(
      {
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
