...
@Component({
  selector: 'app-itmanagementmarket',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './itmanagementmarket.component.html',
  styleUrls: ['./itmanagementmarket.component.scss']
})
export class ItmanagementmarketComponent extends AbstractComponent {
  ...
  contentvalue: string = '';
  result: any = [];
  periodcellvalue: any = ['b8', 'c8', 'b9', 'c9', 'b10', 'c10', 'b11', 'c11'];
          ...
          if (data.status == "Success") {
            if (data.resultList != null) {
              ...
              for (let i = 0; i < this.periodcellvalue.length; i++) {
                this.result[i] = data.resultList[0].itManagementCM.itmanagementperioddata[this.periodcellvalue[i]];
              }
              let outlookdata = data.resultList[0].itManagementCM.itmanagementperioddata.b5;
