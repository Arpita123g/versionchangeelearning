...
@Component({
  selector: 'app-pricingcaseinnovate',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './pricingcaseinnovate.component.html',
  styleUrls: ['./pricingcaseinnovate.component.scss']
})
export class PricingcaseinnovateComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "n7") || (cellname == "n8") || (cellname == "n9") || (cellname == "k11") || (cellname == "k15")
      || (cellname == "k16") || (cellname == "k17") || (cellname == "k18") || (cellname == "k19") || (cellname == "k20")
      || (cellname == "k21")) {
