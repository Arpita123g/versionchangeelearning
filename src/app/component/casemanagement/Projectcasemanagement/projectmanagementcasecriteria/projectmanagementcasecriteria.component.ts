...
@Component({
  selector: 'app-projectmanagementcasecriteria',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './projectmanagementcasecriteria.component.html',
  styleUrls: ['./projectmanagementcasecriteria.component.scss']
})
export class ProjectmanagementcasecriteriaComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
