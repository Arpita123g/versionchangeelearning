...
@Component({
  selector: 'app-designthinkingcaseobserve',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule,TippyDirective,NgxSimpleTextEditorModule],
  templateUrl: './designthinkingcaseobserve.component.html',
  styleUrls: ['./designthinkingcaseobserve.component.scss']
})
export class DesignthinkingcaseobserveComponent extends AbstractComponent {
  defaultcase: string = "";
...
Instructorelementdetailssub: Subscription;
  ...
  contentvaluechange() {
    ...
    this._api.updatecasemanagementdata(String(round), "normal", "no", 'designthinkingcm', body, {}, apiname, 'designThinkingCMActiveStatus').subscribe(
      {
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
