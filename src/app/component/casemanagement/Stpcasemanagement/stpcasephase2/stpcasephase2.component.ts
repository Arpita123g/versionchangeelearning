...
@Component({
  selector: 'app-stpcasephase2',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './stpcasephase2.component.html',
  styleUrls: ['./stpcasephase2.component.scss']
})
export class Stpcasephase2Component extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "w10") || (cellname == "w11") || (cellname == "w12") || (cellname == "w13") || (cellname == "w123")
