...
@Component({
  selector: 'app-itcasemanagementsucurity',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './itcasemanagementsucurity.component.html',
  styleUrls: ['./itcasemanagementsucurity.component.scss']
})
export class ItcasemanagementsucurityComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
