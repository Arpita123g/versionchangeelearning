...
@Component({
  selector: 'app-hrpcasesupplyforecast',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './hrpcasesupplyforecast.component.html',
  styleUrls: ['./hrpcasesupplyforecast.component.scss']
})
export class HrpcasesupplyforecastComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    value = value.replace(",", "");
    if ((cellname == "i6") || (cellname == "i7") || (cellname == "i8") || (cellname == "i9") || (cellname == "v11")
