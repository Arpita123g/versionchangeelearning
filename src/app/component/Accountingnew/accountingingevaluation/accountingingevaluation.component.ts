...
@Component({
  selector: 'app-accountingingevaluation',
  standalone: true,
  imports: [CommonModule, MatDialogModule,MatIconModule],
  templateUrl: './accountingingevaluation.component.html',
  styleUrls: ['./accountingingevaluation.component.scss']
})
export class AccountingingevaluationComponent extends AbstractComponent {
  ...
  writeevaluation(){
    ...
    this._api.accountingDataWrite("accountinggame", 1,
      body, apiname, 'accountinggamecmid').subscribe((data: any) => {
        if (data.status == "Success") {
          // this.getFetchData();
        }
      }, (error: any) => {
