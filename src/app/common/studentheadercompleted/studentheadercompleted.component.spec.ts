...
import { StudentheadercompletedComponent } from './studentheadercompleted.component';
import { GlobalService } from '../../service/global.service';
import { BehaviorSubject } from 'rxjs';

describe('StudentheadercompletedComponent', () => {
  let component: StudentheadercompletedComponent;
  let fixture: ComponentFixture<StudentheadercompletedComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [StudentheadercompletedComponent],
      providers: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(StudentheadercompletedComponent);
