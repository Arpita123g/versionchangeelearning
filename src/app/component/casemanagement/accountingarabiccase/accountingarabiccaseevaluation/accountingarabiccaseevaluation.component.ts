...
@Component({
  selector: 'app-accountingarabiccaseevaluation',
  standalone: true,
  imports: [CommonModule, MatDialogModule, NgApexchartsModule,MatIconModule],
  templateUrl: './accountingarabiccaseevaluation.component.html',
  styleUrls: ['./accountingarabiccaseevaluation.component.scss']
})
export class AccountingarabiccaseevaluationComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
