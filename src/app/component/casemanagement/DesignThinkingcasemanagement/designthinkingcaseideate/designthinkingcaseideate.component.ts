...
@Component({
  selector: 'app-designthinkingcaseideate',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './designthinkingcaseideate.component.html',
  styleUrls: ['./designthinkingcaseideate.component.scss']
})
export class DesignthinkingcaseideateComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "s7") || (cellname == "s8") || (cellname == "s9") || (cellname == "s10") || (cellname == "s11")
      || (cellname == "s12") || (cellname == "s13") || (cellname == "s14") || (cellname == "s15") || (cellname == "s16")
    ) {
