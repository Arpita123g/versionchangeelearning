...
export class ValuechaindecisionchecklistComponent extends AbstractComponent {
  ...
  blankInputMessage: any = ['Estimated Market Growth %', 'Estimated Market Share %', 'In-house Capacity Utilization %',
        ...
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
              ...
              this.submitprove = data.resultList[0].z42;
              if ((this.submitprove == 'yes') || (this.timefinished)) {
                this.disabled = true;
              }else{
                this.disabled = false;
              }
              this.responseresultcm = data.resultList[0].valueChainCM;
              ...
              this.kpivaluearray = [Number((data.resultList[0].l39) * 100).toFixed(2),
              Number((data.resultList[0].l56) * 100).toFixed(2),
              (Number(data.resultList[0].i29)).toFixed(0)]
...
export class ValuechaindecisinchecklistPopup extends AbstractComponent {
  ...
  save() {
    ...
    this._api.promotionsdatawrite("valuechain", 1,
      decisionsubmitData, apiname, 'valuechaincmid').subscribe((data: any) => {
  ...
  async sendfeedbackvalue() {
    ...
    await this._api.gptfeedback(this.noofattempt, this.data.feedback, apiname, "Value Chain").subscribe((data: any) => {
  ...
  async sendAssesmentValue() {
    ...
    await this._api.gptassessment(this.noofattempt, this.data.participantsentiment, this.data.assesment,
      apiname, "Value Chain").subscribe((data: any) => {
