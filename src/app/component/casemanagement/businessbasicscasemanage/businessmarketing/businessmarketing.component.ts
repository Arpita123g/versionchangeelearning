...
@Component({
  selector: 'app-businessmarketing',
  standalone: true,
  imports: [CommonModule, MatDialogModule, NgApexchartsModule,MatIconModule],
  templateUrl: './businessmarketing.component.html',
  styleUrls: ['./businessmarketing.component.scss']
})
export class BusinessmarketingComponent extends AbstractComponent {
  // status:boolean = true;
  defaultcase: string = "";
  res: any = [];
