...
@Component({
  selector: 'app-salestargetmarket',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './salestargetmarket.component.html',
  styleUrls: ['./salestargetmarket.component.scss']
})
export class SalestargetmarketComponent extends AbstractComponent {
        ...
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
              ...
              let outlookdata = data.resultList[0].salesTargetCM.b5;
