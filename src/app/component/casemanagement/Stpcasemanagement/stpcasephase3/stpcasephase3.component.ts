...
@Component({
  selector: 'app-stpcasephase3',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './stpcasephase3.component.html',
  styleUrls: ['./stpcasephase3.component.scss']
})
export class Stpcasephase3Component extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "ah10") || (cellname == "ah11") || (cellname == "ah12") || (cellname == "ah13") || (cellname == "ah115")
