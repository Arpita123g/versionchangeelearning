...
@Component({
  selector: 'app-accountingcasememo',
  standalone: true,
  imports: [CommonModule, MatDialogModule, NgApexchartsModule,MatIconModule, NgxSimpleTextEditorModule,FormsModule],
  templateUrl: './accountingcasememo.component.html',
  styleUrls: ['./accountingcasememo.component.scss']
})
export class AccountingcasememoComponent extends AbstractComponent {
  defaultcase: string = "";
 ...
 Instructorelementdetailssub: Subscription;
  ...
  contentvaluechange() {
    ...
    this._api.updatecasemanagementdata(String(round), "normal", "no", 'accountinggamecm', body, {}, apiname, 'accountinggamecmactivestatus').subscribe(
      {
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
