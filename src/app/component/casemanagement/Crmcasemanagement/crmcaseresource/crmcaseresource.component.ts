...
@Component({
  selector: 'app-crmcaseresource',
  standalone: true,
  imports: [CommonModule, FormsModule, MatIconModule, NgApexchartsModule, TippyDirective],
  templateUrl: './crmcaseresource.component.html',
  styleUrls: ['./crmcaseresource.component.scss']
})
export class CrmcaseresourceComponent extends AbstractComponent {
  defaultcase:string = "";
  res: any = [];
