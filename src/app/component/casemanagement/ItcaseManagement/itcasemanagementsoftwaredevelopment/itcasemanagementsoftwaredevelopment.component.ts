...
@Component({
  selector: 'app-itcasemanagementsoftwaredevelopment',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './itcasemanagementsoftwaredevelopment.component.html',
  styleUrls: ['./itcasemanagementsoftwaredevelopment.component.scss']
})
export class ItcasemanagementsoftwaredevelopmentComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
