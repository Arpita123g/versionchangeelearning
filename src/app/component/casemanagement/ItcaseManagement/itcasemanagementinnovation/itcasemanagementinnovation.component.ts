...
@Component({
  selector: 'app-itcasemanagementinnovation',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './itcasemanagementinnovation.component.html',
  styleUrls: ['./itcasemanagementinnovation.component.scss']
})
export class ItcasemanagementinnovationComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
