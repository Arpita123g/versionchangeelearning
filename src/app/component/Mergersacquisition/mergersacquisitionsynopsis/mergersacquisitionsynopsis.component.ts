...
@Component({
  selector: 'app-mergersacquisitionsynopsis',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule, MarkdownModule],
  templateUrl: './mergersacquisitionsynopsis.component.html',
  styleUrls: ['./mergersacquisitionsynopsis.component.scss'],
  animations: [
...
export class MergersacquisitionsynopsisComponent extends AbstractComponent {
  ...
  databasecellname: any[] = ['b24', 'ac23', 'ac26', 'ac27', 'ac28', 'c35', 'c36', 'c37', 'f38', 'f39',//9
    'c29', 'h29', 'g28', 'ac37', 'ac38', 'ac39', 'j24', 'f24', 'h24', 'g24', 'i24', 'k24', 'l24',]//22
          ...
          if (data.status == "Success") {
            if (data.resultList != null) {
              ...
              for (let i = 0; i < data.resultList.length; i++) {
                let outlookdata = data.resultList[i].j24;
  ...
  downloadreportmergersacquisitionigment() {
    let apiname = '/mergersacquisition/fetchmergersacquisition';
    this.excelsheetservice.downloadReportforgame(apiname, "mergersacquisition", this.useremail, this.coursecode, this.studentsectionid, this.noofattempt, this.studentelementdetailsvalue.courseDetails.coursename, this.studentelementdetailsvalue.coursedetailsid);
