...
@Component({
  selector: 'app-logisticscaseinbound',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './logisticscaseinbound.component.html',
  styleUrls: ['./logisticscaseinbound.component.scss']
})
export class LogisticscaseinboundComponent extends AbstractComponent {
  defaultcase:string = "";
  res: any = [];
