...
@Component({
  selector: 'app-crmgamemarket',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './crmgamemarket.component.html',
  styleUrls: ['./crmgamemarket.component.scss']
})
export class CrmgamemarketComponent extends AbstractComponent {
        ...
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
              ...
              let outlookdata = data.resultList[0].crmGameLM[this.languageselect.toLowerCase()].b23;
              ...
              this.foodvalue = data.resultList[0].crmGameLM[this.languageselect.toLowerCase()].b22;
            }
