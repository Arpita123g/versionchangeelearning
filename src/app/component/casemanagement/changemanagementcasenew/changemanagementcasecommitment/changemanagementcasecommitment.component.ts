...
@Component({
  selector: 'app-changemanagementcasecommitment',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './changemanagementcasecommitment.component.html',
  styleUrls: ['./changemanagementcasecommitment.component.scss']
})
export class ChangemanagementcasecommitmentComponent extends AbstractComponent implements OnChanges, OnDestroy {
  defaultcase: string = "";
  res: any = [];
