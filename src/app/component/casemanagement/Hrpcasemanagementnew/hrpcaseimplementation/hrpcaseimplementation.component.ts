...
@Component({
  selector: 'app-hrpcaseimplementation',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './hrpcaseimplementation.component.html',
  styleUrls: ['./hrpcaseimplementation.component.scss']
})
export class HrpcaseimplementationComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
