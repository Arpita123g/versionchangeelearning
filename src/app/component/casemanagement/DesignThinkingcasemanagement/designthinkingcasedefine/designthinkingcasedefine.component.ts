...
@Component({
  selector: 'app-designthinkingcasedefine',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],  
  templateUrl: './designthinkingcasedefine.component.html',
  styleUrls: ['./designthinkingcasedefine.component.scss']
})
export class DesignthinkingcasedefineComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
