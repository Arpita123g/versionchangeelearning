...
@Component({
  selector: 'app-accountingingreport',
  standalone: true,
  imports: [CommonModule, FormsModule, NgApexchartsModule,MatIconModule],
  templateUrl: './accountingingreport.component.html',
  styleUrls: ['./accountingingreport.component.scss']
})
export class AccountingingreportComponent extends AbstractComponent {
  ...
  constructor(_router: Router, _login: LoginService,
    ...
    this.opportunitieschart = {
      ...
      xaxis: {
        categories: [['Investment in Research', 'and Development',], ['Introduction of Premium', 'Product Line'],
          ...
          if (data.status == "Success") {
            if (data.resultList != null) {
              ...
              if ((this.submitprove == "No") || (this.submitprove == "no") || (this.submitprove == null)) {
                ...
                this.opportunitieschart.series =[{"name": "1-Year Value Creation", "data":this.jsonarray5},
                {"name": "3-Year Value Creation", "data":this.jsonarray6}
                ]
  ...
  downloadreportaccounting() {
    let apiname = '/accountinggame/fetchaccountinggame';
    this.excelsheetservice.downloadReportforgame(apiname, "accountinggame", this.useremail, this.coursecode, this.studentsectionid, this.noofattempt, this.studentelementdetailsvalue.courseDetails.coursename,
