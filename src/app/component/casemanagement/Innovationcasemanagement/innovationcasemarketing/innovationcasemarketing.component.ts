...
@Component({
  selector: 'app-innovationcasemarketing',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './innovationcasemarketing.component.html',
  styleUrls: ['./innovationcasemarketing.component.scss']
})
export class InnovationcasemarketingComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "r7") || (cellname == "r8") || (cellname == "r9") || (cellname == "v10") || (cellname == "v11")
