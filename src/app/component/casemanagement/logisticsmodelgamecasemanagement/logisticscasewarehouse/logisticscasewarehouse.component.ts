...
@Component({
  selector: 'app-logisticscasewarehouse',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './logisticscasewarehouse.component.html',
  styleUrls: ['./logisticscasewarehouse.component.scss']
})
export class LogisticscasewarehouseComponent extends AbstractComponent {
  defaultcase:string = "";
  res: any = [];
