...
@Component({
  selector: 'app-accountingingmemo',
  standalone: true,
  imports: [CommonModule, FormsModule, MatDialogModule],
  templateUrl: './accountingingmemo.component.html',
  styleUrls: ['./accountingingmemo.component.scss']
})
export class AccountingingmemoComponent extends AbstractComponent {
        ...
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
              ...
              let outlookdata = data.resultList[0].accountingGameCM.b5;
