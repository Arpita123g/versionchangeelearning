...
@Component({
  selector: 'app-businesinvestment',
  standalone: true,
  imports: [CommonModule, MatDialogModule, NgApexchartsModule,MatIconModule],
  templateUrl: './businesinvestment.component.html',
  styleUrls: ['./businesinvestment.component.scss']
})
export class BusinesinvestmentComponent extends AbstractComponent {
  res: any = [];
  // status:boolean = true;
  defaultcase: string = "";
  ...
  writeInvestmentValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "p17") || (cellname == "p18") || (cellname == "p19")) {
