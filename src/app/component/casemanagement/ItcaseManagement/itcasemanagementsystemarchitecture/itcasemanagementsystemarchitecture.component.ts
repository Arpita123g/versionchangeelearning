...
@Component({
  selector: 'app-itcasemanagementsystemarchitecture',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './itcasemanagementsystemarchitecture.component.html',
  styleUrls: ['./itcasemanagementsystemarchitecture.component.scss']
})
export class ItcasemanagementsystemarchitectureComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "h12") || (cellname == "h13") || (cellname == "h14") || (cellname == "h15") || (cellname == "h18")
      || (cellname == "h19") || (cellname == "h20") || (cellname == "h21") || (cellname == "f57")) {
