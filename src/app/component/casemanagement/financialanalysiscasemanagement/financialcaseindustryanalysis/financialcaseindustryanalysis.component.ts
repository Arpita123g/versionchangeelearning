...
@Component({
  selector: 'app-financialcaseindustryanalysis',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './financialcaseindustryanalysis.component.html',
  styleUrls: ['./financialcaseindustryanalysis.component.scss']
})

export class FinancialcaseindustryanalysisComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "e34") || (cellname == "e35") || (cellname == "e36") || (cellname == "e37")
      || (cellname == "e44") || (cellname == "e45") || (cellname == "e46") || (cellname == "e47")
      || (cellname == "e54") || (cellname == "e55") || (cellname == "e56") || (cellname == "e57")
    ) {
