...
export class ValuechainsynopsisComponent extends AbstractComponent {
  ...
  downloadreportvaluechainigment() {
    let apiname = '/valuechain/fetchvaluechain';
    this.excelsheetservice.downloadReportforgame(apiname, "valuechain", this.useremail, this.coursecode, this.studentsectionid, this.noofattempt, this.studentelementdetailsvalue.courseDetails.coursename, this.studentelementdetailsvalue.coursedetailsid);
