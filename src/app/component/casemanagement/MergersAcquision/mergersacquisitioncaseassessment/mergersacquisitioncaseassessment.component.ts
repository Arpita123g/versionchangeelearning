...
@Component({
  selector: 'app-mergersacquisitioncaseassessment',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './mergersacquisitioncaseassessment.component.html',
  styleUrls: ['./mergersacquisitioncaseassessment.component.scss']
})
export class MergersacquisitioncaseassessmentComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
