...
@Component({
  selector: 'app-promotionsigmentcasemarket',
  standalone: true,
  imports: [CommonModule, FormsModule, NgxSimpleTextEditorModule],
  templateUrl: './promotionsigmentcasemarket.component.html',
  styleUrls: ['./promotionsigmentcasemarket.component.scss']
})
export class PromotionsigmentcasemarketComponent extends AbstractComponent {
  defaultcase: string = "";
 ...
 Instructorelementdetailssub: Subscription;
  ...
  contentvaluechange() {
    ...
    this._api.updatecasemanagementdata(String(round), "normal", "no", 'promotionscm', body, {}, apiname, 'promotionscmactivestatus').subscribe(
      {
        next: (data: any) => {
          if (data.status == "Success") {
            if (data.resultList != null) {
