...
@Component({
  selector: 'app-innovationcaseproduct',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './innovationcaseproduct.component.html',
  styleUrls: ['./innovationcaseproduct.component.scss']
})
export class InnovationcaseproductComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
