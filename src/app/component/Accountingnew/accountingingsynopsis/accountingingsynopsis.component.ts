...
@Component({
  selector: 'app-accountingingsynopsis',
  standalone: true,
  imports: [CommonModule, MatDialogModule,MatIconModule,FormsModule],
  templateUrl: './accountingingsynopsis.component.html',
  styleUrls: ['./accountingingsynopsis.component.scss'],
  animations: [
...
export class AccountingingsynopsisComponent extends AbstractComponent {
