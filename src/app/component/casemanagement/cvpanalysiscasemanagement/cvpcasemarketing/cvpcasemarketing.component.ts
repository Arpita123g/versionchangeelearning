...
@Component({
  selector: 'app-cvpcasemarketing',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './cvpcasemarketing.component.html',
  styleUrls: ['./cvpcasemarketing.component.scss']
})
export class CvpcasemarketingComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
