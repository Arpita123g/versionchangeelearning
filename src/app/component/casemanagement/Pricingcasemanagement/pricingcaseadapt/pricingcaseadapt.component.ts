...
@Component({
  selector: 'app-pricingcaseadapt',
  standalone:true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './pricingcaseadapt.component.html',
  styleUrls: ['./pricingcaseadapt.component.scss']
})
export class PricingcaseadaptComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
  ...
  writeMarketingValue(cellname: string, index: number, value: any) {
    ...
    if ((cellname == "q8") || (cellname == "q9") || (cellname == "q10") || (cellname == "q11") || (cellname == "q12")
      || (cellname == "q13") || (cellname == "q14") || (cellname == "q21")) {
