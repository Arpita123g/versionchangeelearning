...
@Component({
  selector: 'app-changemanagementcasemotivation',
  standalone: true,
  imports: [CommonModule, FormsModule,MatIconModule,NgApexchartsModule],
  templateUrl: './changemanagementcasemotivation.component.html',
  styleUrls: ['./changemanagementcasemotivation.component.scss']
})
export class ChangemanagementcasemotivationComponent extends AbstractComponent implements OnChanges, OnDestroy {
  defaultcase: string = "";
  res: any = [];
