...
@Component({
  selector: 'app-businesdemand',
  standalone: true,
  imports: [CommonModule, MatDialogModule, NgApexchartsModule,MatIconModule], 
  templateUrl: './businesdemand.component.html',
  styleUrls: ['./businesdemand.component.scss']
})
export class BusinesdemandComponent extends AbstractComponent {
