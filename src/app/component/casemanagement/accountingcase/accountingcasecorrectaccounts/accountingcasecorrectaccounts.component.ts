...
@Component({
  selector: 'app-accountingcasecorrectaccounts',
  standalone: true,
  imports: [CommonModule, MatDialogModule, NgApexchartsModule,MatIconModule],
  templateUrl: './accountingcasecorrectaccounts.component.html',
  styleUrls: ['./accountingcasecorrectaccounts.component.scss']
})
export class AccountingcasecorrectaccountsComponent extends AbstractComponent {
  defaultcase: string = "";
  res: any = [];
